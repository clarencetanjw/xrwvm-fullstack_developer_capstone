...
def initiate():
    car_make_data = [
        {"name":"NISSAN", "description":"Great cars. Japanese technology", 'year': 2020},
        {"name":"Mercedes", "description":"Great cars. German technology", 'year': 2021},
        {"name":"Audi", "description":"Great cars. German technology", 'year':2022},
        {"name":"Kia", "description":"Great cars. Korean technology", 'year':2023},
        {"name":"Toyota", "description":"Great cars. Japanese technology", 'year':2024},
    ]
    ...
    for data in car_make_data:
        car_make_instances.append(CarMake.objects.create(
            ...
            year=data.get('year')  # Ensure the 'year' key is present in the data
        ))
